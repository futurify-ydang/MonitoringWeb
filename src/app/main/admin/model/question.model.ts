...
export const QUESTION_DATA: Question[] = [
    ...
    {id: 1, question : 'How many thinks next year will be better than this year?', answer: '', type: EQuestionType.HasMultiAnswer, listChild: [
        {id: 1, question : 'Yes?', answer: '', type: EQuestionType.Number, listChild: []},
        {id: 1, question : 'No?', answer: '', type: EQuestionType.Number, listChild: []},
        {id: 1, question : 'The same?', answer: '', type: EQuestionType.Number, listChild: []}
    ]},
