...
import { locale as commonEnglish } from 'app/i18n/en';
import { locale as commonVietnam } from 'app/i18n/vi';
...
export class AppComponent implements OnInit, OnDestroy
{
    ...
    )
    {
        ...
        this._fuseTranslationLoaderService.loadTranslations(commonEnglish, commonVietnam);
    ...
    ngOnInit(): void
    {
        ...
        //     this._router.navigate(['/auth/login']);
        // } 
        let userLanguage = this._loginService.getLanguageOfUser().toLowerCase();
